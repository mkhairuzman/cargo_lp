...
const stages = [
  {
    ...
    name: 'Booking',
    status: 'completed',
    description: 'Shipment confirmed and assigned to our coordination team. Documents collected and pre-clearance initiated.',
    time: '14 Sep · 09:30',
  ...
  },
  {
    ...
    name: 'Pickup',
    status: 'completed',
    description: 'Cargo collected from origin facility. Container sealed and verified against packing list. Weight confirmed.',
    time: '15 Sep · 11:15',
    location: 'Jeddah Port, KSA',
  },
  {
    num: '03',
    name: 'Export Clearance',
    status: 'completed',
    description: 'Export declaration approved. Customs clearance completed. Vessel booking confirmed for container AF-2841.',
    time: '16 Sep · 14:00',
    location: 'Jeddah Port, KSA',
  },
  {
    ...
    status: 'active',
    description: 'Container loaded aboard MV Meridian Express. Vessel en route via Indian Ocean. AIS tracking active.',
    time: '17 Sep · 06:45',
    location: 'Indian Ocean — In Transit',
  },
  {
    num: '05',
    name: 'Import Clearance',
    status: 'pending',
    description: 'Documents pre-lodged with Malaysian Customs. Clearance processing will begin upon arrival at Port Klang.',
    time: 'Est. 24 Sep · 08:00',
  ...
  },
  {
    ...
    name: 'Final Delivery',
    status: 'pending',
    description: 'Last-mile transport arranged. Delivery appointment confirmed with consignee at Kuala Lumpur warehouse.',
    time: 'Est. 25 Sep · 14:20',
